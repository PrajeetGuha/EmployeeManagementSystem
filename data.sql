...
insert into employee(emp_id, emp_name, designation, empstatus) values(4, "Jayant Srivastava", "BA", "INACTIVE");
insert into employee(emp_id, emp_name, designation, empstatus) values(5, "Zingchou Chou", "DBA", "ACTIVE");
insert into employee(emp_id, emp_name, designation, empstatus) values(6, "Paramita Mandal", "HR", "ACTIVE");
insert into employee(emp_id, emp_name, designation, empstatus) values(7, "Shekhar Murthy", "ASE", "ACTIVE");
