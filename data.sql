...
insert into employee(emp_id, emp_name, work_email, designation, empstatus) values(4, "Jayant Srivastava","jayants@nrifintech.com", "BA", "INACTIVE");
insert into employee(emp_id, emp_name, work_email, designation, empstatus) values(5, "Zingchou Chou","zingchouc@nrifintech.com", "DBA", "ACTIVE");
insert into employee(emp_id, emp_name, work_email, designation, empstatus) values(6, "Paramita Mandal","paramitam@nrifintech.com", "HR", "ACTIVE");
