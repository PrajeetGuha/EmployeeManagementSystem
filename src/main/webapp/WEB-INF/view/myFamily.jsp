											...
											<div class="modal-body">
													<div class="form-group">
														<label>Family Member Name</label><input type="text" class="form-control" name="name"
															pattern= "[a-zA-Z][a-zA-Z\\s_]*" oninvalid="setCustomValidity('Name can only contain alphabetic characters, underscores, and one whitespace between each word')"
												onchange="setCustomValidity('')"required>
													</div>
													<div class="form-group">
														<label>Relation</label><input type="text" class="form-control" name="relation"
															pattern= "[a-zA-Z][a-zA-Z\\s_]*" oninvalid="setCustomValidity('Relation can only contain alphabetic characters, underscores, and one whitespace between each word')"
												onchange="setCustomValidity('')" required>
													</div>
													<div class="form-group">
														<label>Occupation</label><input type="text" class="form-control" name="occupation"
															pattern= "[a-zA-Z][a-zA-Z\\s_]*" oninvalid="setCustomValidity('Occupation can only contain alphabetic characters, underscores, and one whitespace between each word')"
												onchange="setCustomValidity('')" required>
													</div>
													<div class="form-group">
														<label>Date Of Birth</label> <input type="date" id="start_date" class="form-control"  
														name="dob" oninput="updateMin()"
															required>
													</div>
