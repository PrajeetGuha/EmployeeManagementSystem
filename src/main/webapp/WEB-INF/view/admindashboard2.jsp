						...
						<div class="modal-content">
							<form action="proAlloc" method="post">
								...
								<div class="modal-body">
									...
									<div class="form-group">
										<label>Project Name</label> <input type="text" class="form-control" required>
									</div>
											...
											<tr>
												...
												<td><a href="#editEmployeeModal" class="edit" data-toggle="modal"> <i
														...
														class="delete" data-toggle="modal"> <i class="material-icons"
															...
															onclick="selectedEmp(${employee.empId})">&#xE152;</i></a>
												</td>
											</tr>
											</c:forEach>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<form>
											...
											<div class="modal-body">
												<p>Edit status for this <span id="empId"></span></p>

											</div>
											<div class="modal-footer">
												<input type="submit" class="btn btn-primary" value="Active" id="statusactivate">
												<input type="submit" class="btn btn-danger" value="Inactive" id = "statusdeactivate">
											</div>
										</form>
									</div>
								</div>
