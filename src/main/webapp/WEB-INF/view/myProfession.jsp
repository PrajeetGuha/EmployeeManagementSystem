					...
					<div class="wrapper">
						...
						<nav id="sidebar">
							...
							<ul class="list-unstyled components">
								...
								<li class="active"><a href="professionaldetails">
      ...
      <span class="material-icons text-white">signal_cellular_alt
						...
						<li class="breadcrumb-item active" aria-current="page">Dashboard</li>
							...
							<div class="row" style="margin-right: 0px">
										...
										<table class="table table-striped table-hover">
											...
											<tbody>
												<tr>
													...
													<c:forEach items="${listOfProfession}" var="professionInfo">
												<tr>
													<td>
														<c:out value="${professionInfo.nameOfPrevOrg}" />
													</td>
													
													<td>
														<c:out value="${professionInfo.fromDate}" />
													</td>
													<td>
														<c:out value="${professionInfo.toDate}" />
													</td>
													<td>
								...
								<div class="col-1"></div>
								<!-- Edit Modal HTML -->
								<div id="addProfessionModal" class="modal fade">
									<div class="modal-dialog">
										<div class="modal-content">
