...
<br>
                    <div class="container-fluid ">
                        <div class="row">
                            <div class="col-10">
                                <form method="POST" action="editemployee?search=${search}&pg=${pg}" modelAttribute="employeeinfo">
                                                        ...
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <c:set var="employeeType"
                                                                        value="${['full time', 'intern', 'contract']}" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="input-group ">
                                                                        <input type="text" class="form-control"
                                                                            placeholder="Unassigned" aria-label="Department"
                                                                            aria-describedby="basic-addon1" 
                                                                            value="${employee.department.departmentName}" disabled />
                                                                    </div>
                                                                </td>
                                                            </tr>
