<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Login</title>
        <link href="resources/custom/css/login/login.css" rel="stylesheet" type="text/css">
        <link href="resources/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    </head>

    <body>
        <nav>
            <div class="logo"><img src="resources/assets/logo.png" /></div>
            <div class="navLinks">
                <ul>
    ...
    <script type="text/javascript" src="resources/lib/bootstrap/js/bootstrap.bundle.min.js" />
